...
j'ai ce message : Uncaught ReferenceError: myVariable is not defined at index.html:69:21
La variable nommée myVariable n'a pas été définie ou déclarée dans le code.